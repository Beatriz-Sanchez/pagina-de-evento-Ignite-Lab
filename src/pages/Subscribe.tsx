            ...
            <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    >
                        ...
                        disabled={loading}
                        type="submit"
                        className={classNames("mt-4 bg-green-500 uppercase py-4 rounded font-bold text-sm hover:bg-green-700 transition-colors disabled-opacity-50", {"cursor-progress": loading})}
                        >
